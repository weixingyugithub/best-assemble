...
//            String name) {
//        topLevelClass.addImportedType(new FullyQualifiedJavaType(                "com.beijing.wei.util.file.generatorMybatis.Page"));
//        CommentGenerator commentGenerator = context.getCommentGenerator();
//        Field field = new Field();
//        field.setVisibility(JavaVisibility.PROTECTED);
//        field.setType(new FullyQualifiedJavaType("com.beijing.wei.util.file.generatorMybatis.Page"));
//        field.setName(name);
...
//        method.addParameter(new Parameter(new FullyQualifiedJavaType(                "com.beijing.wei.util.file.generatorMybatis.Page"), name));
//        method.addBodyLine("this." + name + "=" + name + ";");
//        commentGenerator.addGeneralMethodComment(method, introspectedTable);
//        topLevelClass.addMethod(method);
//        method = new Method();
//        method.setVisibility(JavaVisibility.PUBLIC);
//        method.setReturnType(new FullyQualifiedJavaType("com.beijing.wei.util.file.generatorMybatis.Page"));
